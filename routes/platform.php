...
Route::screen('logs', \App\Orchid\Screens\Log\LogListScreen::class)
    ->name('platform.content.logs');

Route::screen('articles/{article}/edit', \App\Orchid\Screens\Article\ArticleEditScreen::class)
    ->name('platform.content.articles.edit');

Route::screen('articles', \App\Orchid\Screens\Article\ArticleListScreen::class)
    ->name('platform.content.articles');
